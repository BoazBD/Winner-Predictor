class Bet:
    ...
    def __str__(self):
        ...
        """
        result = f"Bet Type: {self.type}, Date: {self.event_date}, Time: {self.time}, Event: {self.event}, Option1: {self.option1}, Ratio1: {self.ratio1}, Option2: {self.option2}, Ratio2: {self.ratio2}"
